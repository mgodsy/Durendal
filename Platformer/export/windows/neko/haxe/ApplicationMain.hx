...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Sam Bumgardner", "csc-303-platformer", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "csc-303-platformer";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "csc-303-platformer", null, { width: 640, height: 480 });
